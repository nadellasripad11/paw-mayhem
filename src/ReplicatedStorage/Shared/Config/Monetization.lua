...
Monetization.Passes = {
	VIP = { Id = 0, Price = 199, Name = "VIP", Desc = "Gold VIP tag, +25% coins forever, VIP Gold blaster skin and Royal Gold fur." },
	DoubleCoins = { Id = 0, Price = 249, Name = "2x Coins", Desc = "Double every coin reward. Stacks with VIP." },
	EmotePack = { Id = 0, Price = 99, Name = "Emote Pack", Desc = "Unlocks every emote plus the exclusive Dance and Flex." },
	TrailPack = { Id = 0, Price = 149, Name = "Trail Pack", Desc = "Rainbow dash trail and confetti bursts on every elimination." },
} :: { [string]: Pass }
...
Monetization.Products = {
	Gems100 = { Id = 0, Price = 49, Name = "100 Gems", Desc = "A pouch of gems.", Kind = "Gems", Amount = 100 },
	Gems350 = { Id = 0, Price = 149, Name = "350 Gems", Desc = "A bag of gems.", Kind = "Gems", Amount = 350 },
	Gems1000 = { Id = 0, Price = 399, Name = "1,000 Gems", Desc = "A chest of gems.", Kind = "Gems", Amount = 1000 },
	Gems2800 = { Id = 0, Price = 999, Name = "2,800 Gems", Desc = "A vault of gems. Best value!", Kind = "Gems", Amount = 2800 },
	CoinRain = { Id = 0, Price = 99, Name = "Coin Rain", Desc = "Make it rain! Everyone in the server gets 150 coins (you get 300).", Kind = "CoinRain", Amount = 150 },
	StarterPack = { Id = 0, Price = 79, Name = "Starter Pack", Desc = "1,500 coins, 150 gems and the Aurora blaster skin. Once per player.", Kind = "StarterPack" },
} :: { [string]: Product }
